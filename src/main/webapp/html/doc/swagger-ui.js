...
function program9(depth0,data) {
  ...
  stack1 = foundHelper || depth0.notes;
  stack2 = helpers['if'];
  //hyjeong@danawa.com add if
  if (depth0.notes == null || depth0.notes == ""){
    return "";
  }
  tmp1 = self.program(1, program1, data);
  tmp1.hash = {};
  ...
  stack1 = stack2.call(depth0, stack1, tmp1);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  // hyjeong@danawa.com modify width
  ...
  stack1 = stack2.call(depth0, stack1, tmp1);
  if(stack1 || stack1 === 0) { buffer += stack1; }
//hyjeong@danawa.com modify xml url
  //buffer += "\n                </form>\n                <div class='response' style='display:none'>\n                    <h4>Request URL</h4>\n                    <div class='block request_url'></div>\n                    <h4>Response Body</h4>\n                    <div class='block response_body'></div>\n                    <h4>Response Code</h4>\n                    <div class='block response_code'></div>\n                    <h4>Response Headers</h4>\n                    <div class='block response_headers'></div>\n                </div>\n            </div>\n        </li>\n    </ul>\n";
  buffer += "\n                </form>\n                <div class='response' style='display:none'>\n                    <h4>Request JSON URL</h4>\n                    <div class='block request_url'></div>\n                    <h4>Request XML URL</h4>\n                    <div class='block request_xml_url'></div>\n                    <h4>Response Body</h4>\n                    <div class='block response_body'></div>\n                    <h4>Response Code</h4>\n                    <div class='block response_code'></div>\n                    <h4>Response Headers</h4>\n                    <div class='block response_headers'></div>\n                </div>\n            </div>\n        </li>\n    </ul>\n";
  return buffer;});
})();
...
templates['resource'] = template(function (Handlebars,depth0,helpers,partials,data) {
  // hyjeong@danawa.com add if
  if(depth0.description == null || depth0.description == ""){
    return "";
  }
  ...
  // hyjeong@danawa.com add [" : "+depth0.description +]
  //buffer += escapeExpression(stack1) + " : "+depth0.description +  "</a>\n    </h2>\n    <ul class='options'>\n        <li>\n            <a href='#!/";
  buffer += depth0.description + "</a>\n    </h2>\n    <ul class='options'>\n        <li>\n            <a href='#!/";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if (error_free) {
        ...
        // hyjeong@danawa.com add xml url
        Dns=location.href;
        Dns=Dns.split("//");
        Dns="http://"+Dns[1].substr(0,Dns[1].indexOf("/"));
        requestXmlUrl = Dns+invocationUrl.replace('.json', '.xml');
        $(".request_xml_url", $(this.el)).html("<pre><a href='" + requestXmlUrl + "' target='_blank' >" + invocationUrl.replace('.json', '.xml') + "</a></pre>");
